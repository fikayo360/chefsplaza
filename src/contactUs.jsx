const ContactUs = () => {
    return (
        <div className="w-screen h-screen flex flex-col items-center pt-10">
            ...
            <form className="w-[90%] flex flex-col items-center md:mt-20">
                <input className="w-[80%] md:w-[45%] h-[4rem] border-2 border-black border-solid text-1xl mb-10 pl-4 font-mont" type="text" placeholder="email" />
                ...
                <button className="w-[80%] md:w-[45%] h-[3rem] md:h-[4.5rem] border-black border-solid text-1xl text-white bg-blue-800 font-bold font-mont">book your order </button>
            </form>
