const Section3 = () => {
    return (
        <div className="w-screen h-[150vh] md:h-screen  flex flex-col lg:flex-row">
            <div className="lg:w-1/2 w-full h-[60%]  bg-cover bg-center bg-no-repeat" style={{backgroundImage:'url(./african.jpg)'}}></div>
